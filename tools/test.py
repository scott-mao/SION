...
parser.add_argument('--config', default='../experiments/siamrpn_r50_l234_dwxcorr_otb/config.yaml', type=str,
        help='config file')
parser.add_argument('--snapshot', default='../snapshot/rpnpp_base_otb/checkpoint_e39.pth', type=str,
...
# 12 book 13 butterfly 15 conduction1 19 drone1 26 flamingo1 28 girl
