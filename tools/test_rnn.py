...
from pysot.tracker.tracker_builder_rnn import build_tracker
...
parser.add_argument('--config', default='../experiments/siamrpn_r50_l234_dwxcorr/config.yaml', type=str,
        help='config file')
parser.add_argument('--snapshot', default='../snapshot/checkpoint_e2.pth', type=str,
