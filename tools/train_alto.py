...
#            reduce_gradients(model2)
            ...
            if rank == 0 and cfg.TRAIN.LOG_GRADS:
                log_grads(model2.module, tb_writer, tb_idx)
...
#        batch_info = {}
        batch_info2 = {}
        batch_info2['batch_time'] = average_reduce(batch_time)
        batch_info2['data_time'] = average_reduce(data_time)
...
#    optimizer, lr_scheduler = build_opt_lr(dist_model.module,cfg.TRAIN.START_EPOCH)
    optimizer2, lr_scheduler2, paramsD = build_opt_lr2(dist_model2.module, cfg.TRAIN.START_EPOCH)               
    # resume training
    if cfg.TRAIN.RESUME:
