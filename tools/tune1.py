...
from pysot.models.model_publish import ModelPublish
from pysot.tracker.tracker_builder_publish import build_tracker
...
parser.add_argument('--resume', default='../snapshot/rpnpp_iou_2_vot/checkpoint_e11.pth', type=str,
...
parser.add_argument('-l', '--log', default="log_tune.txt", type=str,
                    help='log file')
parser.add_argument('--penalty-k', default='0.08', type=parse_range,
                    help='penalty_k range')
parser.add_argument('--lr', default='0.3, 0.1', type=parse_range,
                    help='lr range')
parser.add_argument('--window-influence', default='0.38', type=parse_range,
                    help='window influence range')
parser.add_argument('--search-region', default='255,256,16', type=parse_range_int,
...
#            outputs = param['network'].track(im)
...
#                    b_overlap = vot_overlap(location, gt_bbox_, (im.shape[1], im.shape[0]))
...
if __name__ == '__main__':
    main()
    #### remove finish.flag #### !rm -rf finish.flag
