...
from toolkit.visualization import draw_success_precision, draw_eao
...
parser.add_argument('--dataset', '-d', type=str, default='OTB100',
                    help='dataset name')
parser.add_argument('--num', '-n', default=3, type=int,
                    help='number of thread to eval')
parser.add_argument('--tracker_prefix', '-t', default='AEDISV',
...
def main():
    ...
    for prfx in args.tracker_prefix:
       trackers1 = glob(os.path.join(args.tracker_path,
                                     args.dataset,
                                     prfx+'*'))
...
#            if k=='Occlusion':
            draw_success_precision(success_ret,'OTB100',v,str(k), precision_ret)
#####################################################################
...
####################################################################
        for k, v in dataset.attr.items():
            if k=='Full Occlusion':
                draw_success_precision(success_ret,'UAV123',v,str(k), precision_ret)
#####################################################################
