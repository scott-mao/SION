...
from pysot.models.model_builder_rnn import ModelBuilder
from pysot.datasets.dataset_draft import TrkDataset
from pysot.core.config import cfg
from pysot.models.netD_draft_rnn import SiamNet_D
...
#        param.requires_grad = True
#        print("params:",netD.parameters())
        
#    for m in netD.modules():
#        if isinstance(m, nn.BatchNorm2d):
#            m.train()
#            print("modules:",netD.module.disc.modules())

    model=netD.module

#    trainable_params += [{'params': [model.conv1x1,model.pack1,model.pack2,model.lstm,model.lstm2,model.ff],
#                          'lr': cfg.TRAIN.BASE_LR}]
    if current_epoch >= cfg.BACKBONE.TRAIN_EPOCH:
        for layer in cfg.BACKBONE.TRAIN_LAYERS:
